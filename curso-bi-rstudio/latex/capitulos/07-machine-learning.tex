...
Una advertencia honesta desde el principio: los datos del curso
(\archivo{ventas\_retail.csv}, \archivo{transacciones.csv}, etc.) se generaron
...
R² (coeficiente de determinación) &
  $1 - \dfrac{\sum (\text{real} - \text{predicho})^2}{\sum (\text{real} - \text{promedio})^2}$ &
...
\textbf{estratificada} con \codigo{createDataPartition()}, para que ambos
