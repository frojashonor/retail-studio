...
\begin{tikzpicture}[
  ...
  % Fila de KPIs
  \node[kpi] at (1.65,-0.5) {Ventas\\ {\normalsize\bfseries \$959,993}\\ {\color{exito}vs. periodo previo}};
  \node[kpi] at (5.25,-0.5) {Ticket promedio\\ {\normalsize\bfseries \$959.99}\\ {\color{exito}vs. periodo previo}};
  \node[kpi] at (8.85,-0.5) {Clientes activos\\ {\normalsize\bfseries 198}\\ {\color{exito}vs. periodo previo}};
  \node[kpi] at (12.45,-0.5) {Margen estimado\\ {\normalsize\bfseries 46.3\%}\\ {\color{exito}vs. periodo previo}};
  % Fila de filtros
...
app \nolinkurl{latex/codigo/apps/03-dashboard-ejecutivo/app.R}, que ya tiene
...
plantilla \nolinkurl{latex/codigo/reportes/02-reporte-ejecutivo.Rmd} ya genera
