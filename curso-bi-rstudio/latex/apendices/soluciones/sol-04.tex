...
los precios está entre \$77 y \$545.
...
El viernes es el día con más transacciones (moda) y también el de más
ventas (\$161,266). Pero revisa el resto de la columna \codigo{ventas}: el
domingo es segundo en ventas y solo tercero en transacciones; el orden no
coincide exactamente, porque el ticket promedio cambia de un día a
...
Ambas reglas marcan las mismas 3 ventas: están por encima de \$4,751 (límite
del IQR) y su $z$ apenas supera 3. Las tres son ventas de 10 unidades a precios altos (más de \$480)
sin descuento: son ventas grandes \emph{legítimas}, no
...
3.4\% y Q4 por 1.9\%). El segundo trimestre cayó 4.4\% contra el primero, el
tercero creció 11.4\% y el cuarto bajó 1.4\%. En el año, las ventas quedaron
1.2\% por debajo de
...
Los clientes premium compraron en promedio 4.8 veces en el año y los no
premium 5.2: los premium incluso compran un poco \emph{menos} (0.36 compras),
aunque la diferencia es pequeña. Con $p = 0.29$ no
...
Los 119 clientes de la clase A (el 60.1\% de la clientela activa) juntan el
79.8\% de los ingresos, y el 20\% de clientes que más gasta (39 clientes)
aporta el 36.7\%.
...
\begin{enumerate}
  ...
  \item Con 150 ventas se esperan $150 \times 0.03 = 4.5$ devoluciones. Tener
        más de 8 ocurre el 3.8\% de los días; no tener ninguna, solo el
        1.0\%.
...
La pendiente estimada es $-2.97$: por cada peso que sube el precio, se
venden en promedio 2.97 unidades menos a la semana. Su intervalo del 95\%
(de $-3.30$ a $-2.64$) contiene el valor real de $-3$, así que la regresión
recuperó la relación simulada. El $R^2$ de 0.87 indica que el precio explica
el 87\% de la variación de las unidades.
...
Con un precio de \$100 esperamos vender unas 201 unidades en la semana,
con un intervalo de predicción de 173 a 229. Con \$200 el modelo predice
$-96$ unidades, algo imposible: los precios observados van de
