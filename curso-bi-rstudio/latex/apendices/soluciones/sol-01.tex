...
12.2\%, y superó su meta (105.6\%). Necesita vender unos \$415,811 al mes para
no perder dinero; vendió unos \$196,589 más que eso, es decir, está 47.3\% por
...
Tres de las cuatro facturas vencen en sábado, algo que conviene saber si tu área de
...
junio. Los mayores crecimientos mensuales fueron en mayo (+18.9\%) y marzo
(+18.2\%), y diciembre cerró fuerte (+14.3\%), típico de la temporada
navideña. El acumulado superó los 3 millones en julio.
\end{solucion}
...
TI tiene el salario promedio más alto (\$38,000) y reparte la mayor bolsa
de bonos (\$91,200), pero el departamento con mayor costo anual de nómina
es Ventas (\$1,062,600), simplemente porque tiene cuatro personas contra
dos de TI. Para comparar departamentos de distinto tamaño conviene mirar
tanto el total como el promedio por persona.
\end{solucion}
...
Oscar   310 mil   155.0%  Verde
Paula   198 mil    99.0%  Amarillo
Raul    260 mil   130.0%  Verde
[1] "Nora"
[1] 6
[1] 209.5
\end{rsalida}
...
El negocio necesita vender 500 unidades para cubrir sus \$85,000 de costos
fijos: cada unidad deja \$170 de contribución y $500 \times 170 = 85{,}000$. \codigo{tryCatch()} ejecuta el código y,
...
\textbf{Conclusiones para Compras:} 10 de los 50 productos (20\%) se venden
por debajo de su costo; en el peor caso el costo es unas 14 veces el
precio, lo que sugiere errores de captura o precios desactualizados que
...
es la de menor venta total, con solo 23 ventas en el año. Recuerda que en
